...
function configureApp (app: ReturnType<typeof express>, seq: typeof sequelize) {
  ...
  app.get('/rest/order/:id', utils.asyncHandler(getOrderById()))
  app.get('/rest/order-lookup', utils.asyncHandler(getOrderByQueryId()))
  app.get('/rest/orders/all', utils.asyncHandler(getAllOrdersUnfiltered()))
  app.get('/rest/address-lookup/:id', getAddressByIdInsecure())
